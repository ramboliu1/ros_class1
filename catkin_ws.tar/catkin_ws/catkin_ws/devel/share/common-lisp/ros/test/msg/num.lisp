...
(cl:defmethod cl:initialize-instance :after ((m <num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-msg:<num> is deprecated: use test-msg:num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-msg:num-val is deprecated.  Use test-msg:num instead.")
  (num m))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-msg:first_name-val is deprecated.  Use test-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-msg:last_name-val is deprecated.  Use test-msg:last_name instead.")
  (last_name m))
...
(cl:defmethod score-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-msg:score-val is deprecated.  Use test-msg:score instead.")
  (score m))
